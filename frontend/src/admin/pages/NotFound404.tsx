...
const NotFound404 = () => {
  ...
  useEffect(() => {
    ...
    const revert = () => {
      tail.animate({ d: pathOrig }, 1600, (window as any).mina.easeinout);
    };

    const animateTail = () => {
      tail.animate({ d: pathMoved }, 1600, (window as any).mina.easeinout, revert);
    };
  ...
  return (
    <Wrapper>
      <svg id="monkey_404" width="600" height="auto" ref={svgRef}>
        <path
          id="cloud"
          className="st0"
